# Clinical Notes Prompt (Production)

"""
Prompt for tiamd_prod_clinical_notes index - Raw/Original clinical notes.
"""
...
- "location": "Patient location/facility"
...
Choose **tiamd_prod_clinical_notes** when the question involves:
