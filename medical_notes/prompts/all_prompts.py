...
**CRITICAL**: Do not include any "#" or "*" in the output
...
- present the neurological management plan recommended by the healthcare providers.
...
- If any neurology note is available in source record for current hospitalization, include the neurology plan from that note here.
- *STRICTLY* Do not include Non Neurological management in this section.
...
HISTORY OF PRESENT ILLNESS
[100-300 words, 1-2 paragraphs]
**Structure:**
**openning sentence (Patient Introduction & Presentation):**
"[Name] is a [age]-year-old [sex] with history of [relevant PMH], admitted on [date] for [primary reason], who now presents with [chief neurological complaint with onset, characteristics, and initial evaluation]."
**Folllowup (Hospital Course & Neurology Trigger):**
Detail symptom evolution, progression, associated neurological features, precipitating events, key interval changes since admission, reason for neurology consultation, and current neurological concerns.
**Ending (Investigations & Current Status):** [Include only if sufficient information]
Summarize relevant imaging/labs/studies completed, current neurological status, and specific management questions requiring neurological input.
...
**Example:**
"Mr. Smith is a 68-year-old male with hypertension and atrial fibrillation on warfarin, admitted on 12/18/2024 for pneumonia, who developed acute onset left-sided weakness and slurred speech this morning at 0800. He was initially alert with left hemiparesis (3/5 strength) and facial droop noted by nursing staff, prompting stat neurology consultation for concern of acute stroke; symptoms have remained stable over the past 3 hours without improvement or worsening. CT head without contrast from today shows no acute hemorrhage, CTA demonstrates right MCA occlusion, and patient remains a potential candidate for intervention pending neurological evaluation and risk-benefit assessment given recent infection and anticoagulation."
